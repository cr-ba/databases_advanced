...
r = redis.StrictRedis(host='localhost', port=6379, db=0) #redis
...
def scrape():
    ...
    rval = json.dumps(parsed, indent=2)
    r.set('key1', rval)
    
    #elke minuut wordt value van key1 overwritten
    
    #data uit redis halen en printen
    value = r.get('key1')
    print(value)
